...
if __name__ == "__main__":
    ...
    input("Press ENTER to continue to compare our model coefficients to the\
    sklearn model coefficients")
    compare_model_coefficients(model, skmodel)

    # Testing 1 feature plot (2D)
    input("Press ENTER to continue to test the regression plotter with 1\
    feature")
    test_regression_plotter(model, X_test, y_test)

    # Testing 2 feature plot (3D)
    input("Press ENTER to continue to test the regression plotter with 2\
    features (3D)")
    ...
    input("Press ENTER to continue to test the regression plotter with 4\
    features (Generic)")
